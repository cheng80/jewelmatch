...
class MatchGameHud extends PositionComponent
  ...
  void render(Canvas canvas) {
    ...
    if (_comboRect.width > 0 && _comboRect.height > 0) {
      ...
      final lh =
          _comboLeftLabel.height + gapLabelValue + _comboLeftValue.height;
      final rh =
    ...
    if (_timeBarRect.width > 0 && _timeBarRect.height > 0) {
      ...
      _timeBarStrokePaint.color = JewelCandyLuminaTheme.outlineBright
      ...
      if (inner.width > 0 && inner.height > 0) {
        ...
        if (g.isTimedMode) {
          ...
          _untimedFillPaint.color = JewelCandyLuminaTheme.secondaryCyan
