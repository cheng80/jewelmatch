...
| [`architecture/progression_score_targets.md`](architecture/progression_score_targets.md) | 진행 모드 레벨별 목표 점수 산식 (레벨 6부터 완화) |
...
| [`tools/ranking_client_contract.md`](tools/ranking_client_contract.md) | 클라이언트 제출값, 제출 시점, HUD 타임 전용 계약 |
